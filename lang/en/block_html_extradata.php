...
$string['html:addinstance'] = 'Add a new HTML mod $USER block';
$string['html:myaddinstance'] = 'Add a new HTML_extradata block to My home';
$string['leaveblanktohide'] = 'leave blank to hide the title';
$string['newhtmlblock'] = '(new HTML_extradata block)';
$string['pluginname'] = 'HTML_extradata';
